      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <Reveal className="flex justify-center" direction="left">
            <div className="relative rounded-2xl p-[1px] bg-gradient-to-br from-accent-cyan/20 to-accent-purple/5 hover:from-accent-cyan/40 hover:to-accent-purple/20 max-w-full shadow-[0_20px_50px_rgba(0,0,0,0.5)] hover:shadow-[0_20px_50px_rgba(230,57,70,0.12)] transition-all duration-500 group cursor-default about-image-card">
